...
export const SettingsSecondaryEmails: React.FC<ISettingsSecondaryEmailsProps> =
  ({ secondaryEmails, updateSecondaryEmails }) => {
    const [showModal, toggleModal] = useState<boolean>(false);

    const [secondaryEmail, setSecondaryEmail] =
      useState<ISettingsSecondaryEmail>({
        name: "",
        email: "",
        signature: "",
      });

    const [secondaryEmailKey, setSecondaryEmailKey] =
...
export const SettingsSecondaryEmailsModal: React.FC<ISettingsSecondaryEmailsModalProps> =
  ({
    ...
    const [validation, setValidation] =
      useState<{ message: string; type: string } | undefined>(undefined);
    ...
    const submitSecondaryEmail = async () => {
      ...
      if (
        !emailRegex.test(secondaryEmail.email) ||
